<div class="container my-4 p-5 bg-hero rounded">
    <div class="py-5 text-white">
        <p class="display-5 fw-bold">Web Galeri Foto Cintya</p>
        <p class="fs-4 col-md-8">Selamat datang digaleri saya, "Mencoba memotivasi diri sendiri adalah seperti menjadi pengacara bagi diri sendiri, kadang sulit dipercaya tapi tetap harus dilakukan"</p>
    </div>
</div>
<div class="container">
    <div class="row">
